...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "BitBonyNetwork") type = BitBonyNetwork;
    if(strType == "BitBonyNetworkVariable") type = BitBonyNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == BitBonyNetwork) s = "BitBonyNetwork";
    if(type == BitBonyNetworkVariable) s = "BitBonyNetworkVariable";
