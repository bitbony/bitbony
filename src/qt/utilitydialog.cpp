    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("BitBony Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About BitBony Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  bitbony-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the BitBony in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 BONY, 0.1 BONY, 1 BONY and 10 BONY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://bitbonypay.atlassian.net/wiki/display/DOC/PrivateSend\">https://bitbonypay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("BitBony Core is shutting down...") + "<br /><br />" +
