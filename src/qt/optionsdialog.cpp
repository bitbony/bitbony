    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("BONY-light"), QVariant("light"));
    ui->theme->addItem(QString("BONY-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("BONY-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("BONY-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("BONY-traditional"), QVariant("trad"));
