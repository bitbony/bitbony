    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("BitBony Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BitBony address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitbony: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About BitBony Core"), this);
    aboutAction->setStatusTip(tr("Show information about BitBony Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BitBony Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BitBony addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BitBony addresses"));
    ...
    openAction->setStatusTip(tr("Open a bitbony: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BitBony Core help message to get a list with possible BitBony Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("BitBony Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BitBony network", "", count));
    } else {
...
{
    QString strTitle = tr("BitBony Core"); // default title
