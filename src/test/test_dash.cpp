...
#define BOOST_TEST_MODULE BitBony Test Suite

#include "test_bitbony.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_bitbony_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
