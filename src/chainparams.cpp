 ...
 * database.
 *
 * CBlock(hash=00000ffd590b14, ver=1, hashPrevBlock=00000000000000, hashMerkleRoot=e0028e, nTime=1524064983, nBits=1e0ffff0, nNonce=28917698, vtx=1)
...
public:
    CMainParams() {
        ...
        genesis = CreateGenesisBlock(1524064983, 28917698, 0x1e0ffff0, 1, 50 * COIN);
        ...
        vSeeds.push_back(CDNSSeedData("bitbony.org", "dnsseed.bitbony.org"));
        vSeeds.push_back(CDNSSeedData("bitbonydot.io", "dnsseed.bitbonydot.io"));
        vSeeds.push_back(CDNSSeedData("masternode.io", "dnsseed.masternode.io"));
        vSeeds.push_back(CDNSSeedData("bitbonypay.io", "dnsseed.bitbonypay.io"));
...
public:
    CTestNetParams() {
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("bitbonydot.io",  "testnet-seed.bitbonydot.io"));
