...
Only requiring some minor changes is bitbony.cpp.
...
Changes to bitbony.cpp
----------------------
bitbony.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
