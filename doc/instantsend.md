...
This mechanism has been integrated into Bitcore-Node-BitBony which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/bitbonypay/insight-api-bitbony#web-socket-api](https://github.com/bitbonypay/insight-api-bitbony#web-socket-api)
* API: [https://github.com/bitbonypay/insight-api-bitbony#instantsend-transactions](https://github.com/bitbonypay/insight-api-bitbony#instantsend-transactions)
...
By default, the BitBony Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the BitBony Core daemon:
