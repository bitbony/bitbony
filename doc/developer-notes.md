...
BitBony Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadSocketHandler : Sends/Receives data from peers on port 9537.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 9536 for connections and services them.
...
However, in open source software such as BitBony Core, where everyone uses
...
pay attention to for reviewers of BitBony Core code.

General BitBony Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: BitBony Core uses tinyformat, which is type safe. Leave them out to avoid confusion
