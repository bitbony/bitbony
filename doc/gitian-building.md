...
git clone https://github.com/bitbonypay/bitbony
```
...
```bash
    ...
    From https://github.com/bitbonypay/bitbony
...
[bitbony/gitian.sigs](https://github.com/bitbonypay/gitian.sigs/) repository, or if that's not possible to create a pull
request.
