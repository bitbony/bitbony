...
* Update translations, see [translation_process.md](https://github.com/bitbony/bitbony/blob/master/doc/translation_process.md#syncing-with-transifex)
...
Check out the source code in the following directory hierarchy.
	...
	git clone https://github.com/bitbony/gitian.sigs.git
...
### Build and sign BitBony Core for Linux, Windows, and OS X:
	...
	./bin/gbuild --commit bitbony=v${VERSION} ../bitbony/contrib/gitian-descriptors/gitian-osx.yml
...
Commit your signature to gitian.sigs:
  ...
  Wait for Windows/OS X detached signatures:
	...
	Detached signatures will then be committed to the [bitbony-detached-sigs](https://github.com/bitbony/bitbony-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - BitBony-development mailing list

  - Update title of #bitbony on Freenode IRC
